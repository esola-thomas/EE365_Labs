...
HD_PWD='D:/My_DevOps/Fall_2022/EE365/EE365_Labs/Lab5/7_Segment_Display.runs/User_LogicImplementation'
cd "$HD_PWD"
...
EAStep vivado -log Diagram_7_Segment_Display_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Diagram_7_Segment_Display_wrapper.tcl -notrace
