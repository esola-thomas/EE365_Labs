...
HD_PWD='D:/My_DevOps/Fall_2022/EE365/EE365_Labs/Lab5/7_Segment_Display.runs/Diagram_7_Segment_Display_system_ila_3_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Diagram_7_Segment_Display_system_ila_3_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Diagram_7_Segment_Display_system_ila_3_0.tcl
