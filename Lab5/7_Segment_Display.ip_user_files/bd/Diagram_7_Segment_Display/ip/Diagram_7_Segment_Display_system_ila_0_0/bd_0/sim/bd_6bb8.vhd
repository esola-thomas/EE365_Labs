...
entity bd_6bb8 is
  ...
  attribute CORE_GENERATION_INFO of bd_6bb8 : entity is "bd_6bb8,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_6bb8,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_6bb8 : entity is "Diagram_7_Segment_Display_system_ila_0_0.hwdef";
end bd_6bb8;

architecture STRUCTURE of bd_6bb8 is
  component bd_6bb8_ila_lib_0 is
  port (
    clk : in STD_LOGIC;
    probe0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    probe1 : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  end component bd_6bb8_ila_lib_0;
...
begin
  ...
  probe8_1(0) <= probe8(0);
ila_lib: component bd_6bb8_ila_lib_0
     port map (
      clk => clk_1,
      probe0(0) => probe0_1(0),
      probe1(0) => probe1_1(0),
