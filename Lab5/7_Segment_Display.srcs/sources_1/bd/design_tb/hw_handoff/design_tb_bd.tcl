...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Clock_50 [get_bd_ports clk] [get_bd_pins Display_Initializer_0/clk] [get_bd_pins Reset_Delay_Startup/iCLK] [get_bd_pins TTL_serial_0/clk] [get_bd_pins Univ_Counter/clk] [get_bd_pins btn_0_debounce/CLK] [get_bd_pins btn_1_debounce_toggle/CLK] [get_bd_pins btn_2_debounce_toggle_2/CLK] [get_bd_pins count_loader/clk] [get_bd_pins system_ila_0/clk] [get_bd_pins system_ila_2/clk] [get_bd_pins system_ila_3/clk] [get_bd_pins system_ila_4/clk]
