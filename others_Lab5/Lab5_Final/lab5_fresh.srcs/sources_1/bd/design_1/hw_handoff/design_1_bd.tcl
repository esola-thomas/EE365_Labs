...
proc create_root_design { parentCell } {
  ...
  set SSN_o [ create_bd_port -dir O SSN_o ]
  set TX_o [ create_bd_port -dir O TX_o ]

  # Create instance: lab5_0, and set properties
  set block_name lab5
  set block_cell_name lab5_0
  if { [catch {set lab5_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net BTN_0_1 [get_bd_ports BTN_0] [get_bd_pins lab5_0/BTN_0]
  connect_bd_net -net BTN_1_1 [get_bd_ports BTN_1] [get_bd_pins lab5_0/BTN_1]
  connect_bd_net -net BTN_2_1 [get_bd_ports BTN_2] [get_bd_pins lab5_0/BTN_2]
  connect_bd_net -net lab5_0_MOSI_o [get_bd_ports MOSI_o] [get_bd_pins lab5_0/MOSI_o]
  connect_bd_net -net lab5_0_SCK_o [get_bd_ports SCK_o] [get_bd_pins lab5_0/SCK_o]
  connect_bd_net -net lab5_0_SSN_o [get_bd_ports SSN_o] [get_bd_pins lab5_0/SSN_o]
  connect_bd_net -net lab5_0_TX_o [get_bd_ports TX_o] [get_bd_pins lab5_0/TX_o]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins lab5_0/iCLK] [get_bd_pins processing_system7_0/FCLK_CLK0]
