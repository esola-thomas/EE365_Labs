...
################################################################
# This is a generated script based on design: Lab_5
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net BTN_0_1 [get_bd_ports BTN_0] [get_bd_pins top_level_0/BTN_0]
  connect_bd_net -net BTN_1_1 [get_bd_ports BTN_1] [get_bd_pins top_level_0/BTN_1]
  connect_bd_net -net BTN_2_1 [get_bd_ports BTN_2] [get_bd_pins top_level_0/BTN_2]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins top_level_0/clk]
  connect_bd_net -net top_level_0_TX [get_bd_ports TX] [get_bd_pins top_level_0/TX_o]
