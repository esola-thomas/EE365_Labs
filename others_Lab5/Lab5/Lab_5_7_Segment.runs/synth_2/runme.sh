...
HD_PWD='D:/My_DevOps/Fall_2022/EE365/EE365_Labs/Lab5/Lab_5_7_Segment.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log Lab_5_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_5_wrapper.tcl
