...
--Date        : Thu Nov 10 22:52:53 2022
--Host        : ALIENWARE running 64-bit major release  (build 9200)
--Command     : generate_target Lab_5.bd
--Design      : Lab_5
...
entity Lab_5 is
  ...
  attribute core_generation_info of Lab_5 : entity is "Lab_5,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Lab_5,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute hw_handoff : string;
  attribute hw_handoff of Lab_5 : entity is "Lab_5.hwdef";
end Lab_5;

architecture STRUCTURE of Lab_5 is
  component Lab_5_processing_system7_0_0 is
  port (
  ...
  end component Lab_5_processing_system7_0_0;
...
begin
  ...
  CLK_1 <= CLK;
  TX <= top_level_0_TX;
processing_system7_0: component Lab_5_processing_system7_0_0
     port map (
