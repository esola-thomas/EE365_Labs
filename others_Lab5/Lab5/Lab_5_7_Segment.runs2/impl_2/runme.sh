...
HD_PWD='D:/My_DevOps/Fall_2022/EE365/EE365_Labs/Lab5/Lab_5_7_Segment.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log Lab_5_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_5_wrapper.tcl -notrace
