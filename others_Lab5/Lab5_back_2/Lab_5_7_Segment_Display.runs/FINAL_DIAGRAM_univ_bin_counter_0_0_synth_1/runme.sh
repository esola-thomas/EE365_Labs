...
HD_PWD='D:/My_DevOps/Fall_2022/EE365/EE365_Labs/Lab5/Lab_5_7_Segment_Display.runs/FINAL_DIAGRAM_univ_bin_counter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FINAL_DIAGRAM_univ_bin_counter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FINAL_DIAGRAM_univ_bin_counter_0_0.tcl
