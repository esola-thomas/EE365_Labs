...
HD_PWD='D:/My_DevOps/Fall_2022/EE365/EE365_Labs/Lab5/Lab_5_7_Segment_Display.runs/root_level_btn_debounce_toggle_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log root_level_btn_debounce_toggle_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source root_level_btn_debounce_toggle_1_0.tcl
