...
HD_PWD='D:/My_DevOps/Fall_2022/EE365/EE365_Labs/Lab5/Lab_5_7_Segment_Display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FINAL_DIAGRAM_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FINAL_DIAGRAM_wrapper.tcl -notrace
