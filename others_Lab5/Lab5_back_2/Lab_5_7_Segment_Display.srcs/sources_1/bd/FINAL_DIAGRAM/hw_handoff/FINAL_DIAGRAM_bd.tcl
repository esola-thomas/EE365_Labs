...
################################################################
# This is a generated script based on design: FINAL_DIAGRAM
#
...
# source FINAL_DIAGRAM_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# Counter_Loader, Reset_Delay, TTL_Serial_user_logic, btn_debounce_toggle, btn_debounce_toggle, btn_debounce_toggle, out_LTU, univ_bin_counter
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net BTN_0_1 [get_bd_ports BTN_0] [get_bd_pins btn_debounce_toggle_0/BTN_I]
  connect_bd_net -net BTN_1_1 [get_bd_ports BTN_1] [get_bd_pins btn_debounce_toggle_1/BTN_I]
  connect_bd_net -net BTN_2_1 [get_bd_ports BTN_2] [get_bd_pins btn_debounce_toggle_2/BTN_I]
  connect_bd_net -net Counter_Loader_0_clk_en_o [get_bd_pins Counter_Loader_0/clk_en_o] [get_bd_pins univ_bin_counter_0/clk_en]
  connect_bd_net -net Counter_Loader_0_load_signal [get_bd_pins Counter_Loader_0/load_signal] [get_bd_pins univ_bin_counter_0/load]
  connect_bd_net -net Counter_Loader_0_load_value [get_bd_pins Counter_Loader_0/load_value] [get_bd_pins univ_bin_counter_0/d]
  connect_bd_net -net Net [get_bd_pins Counter_Loader_0/clk] [get_bd_pins Reset_Delay_0/iCLK] [get_bd_pins TTL_Serial_user_logic_0/clk] [get_bd_pins btn_debounce_toggle_0/CLK] [get_bd_pins btn_debounce_toggle_1/CLK] [get_bd_pins btn_debounce_toggle_2/CLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins univ_bin_counter_0/clk]
  connect_bd_net -net Reset_Delay_0_oRESET [get_bd_pins Reset_Delay_0/oRESET] [get_bd_pins univ_bin_counter_0/syn_clr]
  connect_bd_net -net TTL_Serial_user_logic_0_TX [get_bd_ports TX] [get_bd_pins TTL_Serial_user_logic_0/TX]
  connect_bd_net -net btn_debounce_toggle_0_BTN_O [get_bd_pins Counter_Loader_0/reset] [get_bd_pins btn_debounce_toggle_0/BTN_O] [get_bd_pins univ_bin_counter_0/reset]
  connect_bd_net -net btn_debounce_toggle_1_TOGGLE_O [get_bd_pins btn_debounce_toggle_1/TOGGLE_O] [get_bd_pins univ_bin_counter_0/en]
  connect_bd_net -net btn_debounce_toggle_2_TOGGLE_O [get_bd_pins Counter_Loader_0/up_down] [get_bd_pins btn_debounce_toggle_2/TOGGLE_O] [get_bd_pins univ_bin_counter_0/up]
  ...
  connect_bd_net -net univ_bin_counter_0_min_tick [get_bd_pins Counter_Loader_0/count_min] [get_bd_pins univ_bin_counter_0/min_tick]
