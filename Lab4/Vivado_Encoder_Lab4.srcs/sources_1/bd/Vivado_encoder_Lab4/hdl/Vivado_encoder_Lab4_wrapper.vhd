...
entity Vivado_encoder_Lab4_wrapper is
  port (
    A : in STD_LOGIC;
    B : in STD_LOGIC;
...
end Vivado_encoder_Lab4_wrapper;

architecture STRUCTURE of Vivado_encoder_Lab4_wrapper is
  component Vivado_encoder_Lab4 is
  port (
    A : in STD_LOGIC;
    B : in STD_LOGIC;
    SW_reset : in STD_LOGIC;
...
begin
Vivado_encoder_Lab4_i: component Vivado_encoder_Lab4
     port map (
      A => A,
      B => B,
