...
HD_PWD='C:/Users/schumae/Documents/GitHub/EE365_Labs/Lab4/Vivado_Encoder_Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Vivado_encoder_Lab4_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Vivado_encoder_Lab4_wrapper.tcl -notrace
