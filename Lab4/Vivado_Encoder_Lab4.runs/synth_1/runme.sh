...
HD_PWD='C:/Users/schumae/Desktop/EE365/Lab4/Vivado_Encoder_Lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Vivado_encoder_Lab4_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Vivado_encoder_Lab4_wrapper.tcl
