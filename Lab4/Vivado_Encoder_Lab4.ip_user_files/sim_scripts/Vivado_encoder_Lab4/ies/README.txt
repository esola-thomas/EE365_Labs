...
#
# Generated by export_simulation on Wed Oct 12 22:27:36 -0400 2022
#
################################################################################
...
'-reset_run' switch to the './Vivado_encoder_Lab4.sh' script.

./Vivado_encoder_Lab4.sh -reset_run
...
./Vivado_encoder_Lab4.sh -noclean_files

For more information on the script, please type './Vivado_encoder_Lab4.sh -help'.
