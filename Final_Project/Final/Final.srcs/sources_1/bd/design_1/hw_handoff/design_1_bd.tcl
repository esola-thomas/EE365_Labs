...
proc create_root_design { parentCell } {
  ...
  set iReset_n [ create_bd_port -dir I iReset_n ]

  # Create instance: LCD_ip_0, and set properties
  set LCD_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:LCD_ip:1.0 LCD_ip_0 ]

  # Create instance: Serial_7seg_0, and set properties
  set Serial_7seg_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Serial_7seg:1.0 Serial_7seg_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Serial_7seg_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins LCD_ip_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net LCD_ip_0_LCD_DATA [get_bd_ports LCD_DATA] [get_bd_pins LCD_ip_0/LCD_DATA]
  connect_bd_net -net LCD_ip_0_LCD_EN [get_bd_ports LCD_EN] [get_bd_pins LCD_ip_0/LCD_EN]
  connect_bd_net -net LCD_ip_0_LCD_RS [get_bd_ports LCD_RS] [get_bd_pins LCD_ip_0/LCD_RS]
  connect_bd_net -net Serial_7seg_0_TX [get_bd_ports TX] [get_bd_pins Serial_7seg_0/TX]
  connect_bd_net -net axi_timer_0_interrupt [get_bd_pins axi_timer_0/interrupt] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net iReset_n_1 [get_bd_ports iReset_n] [get_bd_pins LCD_ip_0/iReset_n]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins LCD_ip_0/s00_axi_aclk] [get_bd_pins Serial_7seg_0/s00_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins LCD_ip_0/s00_axi_aresetn] [get_bd_pins Serial_7seg_0/s00_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs LCD_ip_0/S00_AXI/S00_AXI_reg] SEG_LCD_ip_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Serial_7seg_0/S00_AXI/S00_AXI_reg] SEG_Serial_7seg_0_S00_AXI_reg
